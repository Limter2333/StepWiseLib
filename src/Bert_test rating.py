...
bert_clf = FakeReviewClassifier_rating()
bert_clf.to(device)

test_y_tensor = torch.tensor(y_test.tolist()).float()
test_masks_tensor = torch.tensor(test_masks)

test_dataset = TensorDataset(test_tokens_ids, test_masks_tensor,  torch.tensor(rating_test.to_list()), test_y_tensor)
